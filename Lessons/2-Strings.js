...
console.log("$"+10*5) 
/*however if you are performing long calculations, USE BRACKETS!! cause js ads from left-->right and it will look like the this '$' + 50 + 20 == '$5020' if the */

//Creating a very basic bill info
console.log("Items("+( 1 + 1 )+"):      $"+(( 2095 + 800 ) / 100)) //a bit difficult

//USING BACKTICKS i.e template stings `` used to directly insert into the strings using a dollar sign with curly brackets ${}
